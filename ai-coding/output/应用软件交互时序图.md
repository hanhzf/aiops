...
sequenceDiagram
    ...
    rect rgb(240, 240, 240)
        ...
        ScenarioService->>ChatHandler: 发布确认问题 {"chatId": "xxx", "type": "confirm", "content": "请问您是要前往报表生成页面吗？"}
    ...
    rect rgb(240, 250, 240)
        ...
        ScenarioService->>ChatHandler: 发布导航信息 {"chatId": "xxx", "type": "navigation", "url": "/report", "scene": "report"}
...
sequenceDiagram
    ...
    rect rgb(240, 240, 240)
        ...
        DispatcherService-->>ChatHandler: 发布处理结果 {"chatId": "xxx", "data": {...}}
        ChatHandler-->>Client: 推送消息
    end
...
sequenceDiagram
    ...
    rect rgb(240, 240, 240)
        ...
        DispatcherService->>ChatService: 保存响应记录
        DispatcherService-->>ChatHandler: 发布待确认问题 {"chatId": "xxx", "type": "confirm", "content": "请问您是不是要查询今天的所有订单的收入金额的总和？"}
        ChatHandler-->>Client: 推送确认问题
    end
    ...
    rect rgb(240, 250, 240)
        ...
        DispatcherService->>ChatService: 保存响应记录
        DispatcherService-->>ChatHandler: 发布处理结果 {"chatId": "xxx", "data": {...}, "sql": "..."}
        ChatHandler-->>Client: 推送消息
    end
```
